...
const WhatsAppLogo = () => {
  return (
    <>
      <a
        href="https://wa.me/201060820691"
        target="_blank"
        rel="noopener noreferrer"
        className="hidden w-[70px] h-[70px] bg-[#4FCE5D] md:flex justify-center items-center rounded-full fixed bottom-4 right-4 z-50 shadow-lg hover:scale-105 transition-transform"
      >
        <svg
