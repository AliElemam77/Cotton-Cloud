  ...
  const posts = [
    {
      name: "اسم المقالة",
      description:
        "وصف المقالة  ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, voluptate.",
        ...
        <div>
          <div className="mb-5">
            ...
            <p className="text-sm text-gray-500">
              ...
              doloribus deserunt vero amet blanditiis esse laborum consequuntur
              totam a officiis!
            </p>
          </div>
          <div className="mb-5">
      ...
      <section>
        <div className="grid grid-cols-2 gap-5 lg:grid-cols-3">
          {posts.map((post, index) => (
            <div
              key={index}
              className="flex flex-col gap-2 mb-5 bg-white rounded shadow-md"
            >
              ...
              <div className="p-4">
                ...
                <div>
                  <a
                    className="block w-full underline text-end text-secondary-550 hover:text-secondary-700 visited:text-primary-550"
                    href=""
                  >
                    show details
                  </a>
